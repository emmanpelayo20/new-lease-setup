...
class Context:
    ...
    lease_processor_system_prompt: str = field(
        default=prompts.LEASE_PROCESSOR_SYSTEM_PROMPT,
        metadata={
            "description": "The system prompt to use for the lease processor agent's interactions. "
            "This prompt sets the context and behavior for the agent."
        },
    )
    ...
    extraction_agent_system_prompt: str = field(
        ...
        metadata={
            "description": "The system prompt to use for the extraction_agent's interactions. "
            "This prompt sets the context and behavior for the agent."
        },
    )
    ...
    rpa_agent_system_prompt: str = field(
        ...
        metadata={
            "description": "The system prompt to use for the rpa agent's interactions. "
            "This prompt sets the context and behavior for the agent."
        },
    )
